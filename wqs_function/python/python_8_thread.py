...
if __name__ == '__main__':
    ...
    url = 'http://192.168.18.218:8080/3rd_party/mysql/5.7/mysql-5.7.9-1.el6.x86_64.rpm-bundle.tar'
    main(url=url, thread=2, save_file='test.iso', buffer=4096)
    endtime = datetime.datetime.now()
    print 'use: ',(endtime - starttime).seconds,'s'
